...
class RequestProduct extends Component {
  ...
  quickSearch = (e) => {
    ...
    this.setState({ [name]: e.target.value, closeSearch: true })
  ...
  handleTitle = (e) => {
    this.setState({ pname: e.title, closeSearch: false })
  }
                  ...
                  <CRow>
                    <CCol md={6}>
                      ...
                      <CFormInput
                        ...
                        onChange={(e) => this.debounce(this.quickSearch(e))}
                        id="exampleFormControlInput1"
